...
class WebInterface(object):
	...
	def configUpdate(self, http_host='0.0.0.0', http_username=None, http_port=8181, http_password=None, launch_browser=0,
		...
		rename_files=0, correct_metadata=0, cleanup_files=0, add_album_art=0, embed_album_art=0, embed_lyrics=0, destination_dir=None, separate_quality_destination_dirs=0, lossy_destination_dir=None, lossless_destination_dir=None, folder_format=None, file_format=None, include_extras=0, interface=None, log_dir=None,
